...
# Model settings
model = dict(
    type="SPUnetDistillationBase",
    teacher_pretrained="/home/myugolyadkin/storonkin_3d/Pointcept/exp/waymo/semseg-spunet-v1m1-patched/model/model_best.pth",
    student_pretrained="/home/myugolyadkin/storonkin_3d/Pointcept/exp/waymo/semseg-spunet-v1m1-0-base/model/model_best.pth",
    teacher_cfg=dict(
        type="SpUNet-v1m1",
        in_channels=4,
        num_classes=22,
...
data = dict(
    ...
    train=dict(
        ...
        teacher_data_root="data/waymo_patched_v3/patched_v3",
