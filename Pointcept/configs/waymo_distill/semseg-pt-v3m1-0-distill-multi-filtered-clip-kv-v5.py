...
"""
поменял шедулер и пути к весам и clip откл
"""
# misc custom setting
...
# Model settings
model = dict(
    type="MatchesLayerDistillationSegmentorV5",
    teacher_pretrained="/home/myugolyadkin/storonkin_3d/Pointcept/exp/waymo_patched/semseg-pt-v3m1-0-patched-filtered-clip-v2/model/model_best.pth",
    student_pretrained="/home/myugolyadkin/storonkin_3d/Pointcept/exp/waymo_base/semseg-pt-v3m1-0-base-save/model/model_best.pth",
    teacher_cfg=dict(
        type="PT-v3m1",
        in_channels=4,
...
optimizer = dict(type="AdamW", lr=0.0005, weight_decay=0.001)
scheduler = dict(
...
data = dict(
    ...
    names=names,
    train=dict(
        type="DistillationWaymoDataset",
        teacher_data_root="data/waymo_patched_v2",
        student_data_root="data/waymo",
        split="training",
        transform=[
