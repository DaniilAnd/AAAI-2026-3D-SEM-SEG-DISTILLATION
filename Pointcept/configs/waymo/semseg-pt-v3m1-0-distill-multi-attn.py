...
# Model settings
model = dict(
    type="MatchesLayerDistillationSegmentor",
    teacher_pretrained="/home/myugolyadkin/storonkin_3d/Pointcept/exp/waymo/semseg-pt-v3m1-0-patched-filtered/model/model_best.pth",
...
optimizer = dict(type="AdamW", lr=0.00005, weight_decay=0.005)
scheduler = dict(
