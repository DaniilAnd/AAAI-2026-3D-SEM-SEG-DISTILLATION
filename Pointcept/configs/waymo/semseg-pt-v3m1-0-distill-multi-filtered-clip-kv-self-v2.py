...
# Model settings
model = dict(
    type="MatchesLayerDistillationSegmentorSelfV2",
    student_pretrained="/home/myugolyadkin/storonkin_3d/Pointcept/exp/waymo_patched/semseg-pt-v3m1-0-patched-filtered-clip-v2/model/model_best.pth",
    student_cfg=dict(
        type="PT-v3m1",
        in_channels=4,
