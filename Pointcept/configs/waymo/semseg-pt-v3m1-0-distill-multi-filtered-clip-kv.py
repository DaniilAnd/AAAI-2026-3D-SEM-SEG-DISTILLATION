...
# Model settings
model = dict(
    type="MatchesLayerDistillationSegmentorV2",
    teacher_pretrained="/home/myugolyadkin/storonkin_3d/Pointcept/exp/waymo_patched/semseg-pt-v3m1-0-patched-filtered-clip/model/model_best.pth",
...
# optimizer = dict(type='AdamW', lr=0.002, weight_decay=0.005)
# scheduler = dict(type='CosineAnnealingLR', eta_min=1e-06)
