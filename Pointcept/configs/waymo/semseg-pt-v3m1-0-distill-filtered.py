...
enable_amp = True
    ...
    # teacher_pretrained="/home/myugolyadkin/storonkin_3d/Pointcept/exp/waymo/semseg-pt-v3m1-0-patched-07135/model/model_best.pth",
    # student_pretrained="/home/myugolyadkin/storonkin_3d/Pointcept/exp/waymo/semseg-pt-v3m1-0-base-save/model/model_best.pth",
# Model settings
model = dict(
    type="DistillationSegmentor",
    teacher_pretrained="/home/myugolyadkin/storonkin_3d/Pointcept/exp/waymo/semseg-pt-v3m1-0-patched-filtered-h100/model/model_best.pth",
    student_pretrained="/home/myugolyadkin/storonkin_3d/Pointcept/exp/waymo/semseg-pt-v3m1-0-base-save/model/model_best.pth",
    teacher_cfg=dict(
        type="PT-v3m1",
        in_channels=4,
...
data = dict(
    ...
    train=dict(
        ...
        teacher_data_root="data/waymo_patched",
